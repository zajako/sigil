...
$().ready(function(){
  onLoadEvent();
    ...
    function pointsToString()
    {
      ...
      {
        returnString += "new Point("+ _points[i].X +", "+ _points[i].Y +"),";
      }
    ...
    function mouseUpEvent(x, y)
    {
      ...
      if (_isDown)
      {
        ...
        if (_points.length >= 10)
        {
          ...
          $("#generatedText").text('this.Unistrokes[' + (_r.Unistrokes.length) +'] = new Unistroke("' + $("#generatedName").val() + '", new Array(' + pointsToString() + '));');
        }
