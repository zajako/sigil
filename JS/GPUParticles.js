...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = THREE.ImageUtils.loadTexture("./IMG/Textures/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = THREE.ImageUtils.loadTexture("./IMG/Textures/particle2.png");
